...
function preload () {
  ...
  for (let i = 0; i < memeberList.length; i++) {
    ...
    // const data = await createRoundProfileImage.apply(this, [profileImageUrl])
    // // console.log(name, url, joinDate)
    // this.load.image('memberProfile_' + index, data)
  }
}
